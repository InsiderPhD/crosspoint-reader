...
void EpubReaderClippingListActivity::loop() {
  ...
  // Hold Confirm to delete the selected clipping (mirrors the bookmarks list). The
  // deleteHoldTriggered latch prevents repeat-fire while held; it clears on release.
