...
// criterion (empty authorKey, progress < 0, rank == LAST_OPENED_NEVER, dateAddedTs == 0)
// sort to the end. Ties break case-insensitively on sortKey for stable, deterministic order.
