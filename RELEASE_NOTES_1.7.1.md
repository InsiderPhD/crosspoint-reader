# CrossPoint Reader 1.7.1

A reliability and BookFusion-polish release: dependable downloads, BookFusion covers and reading position that actually carry over to your library, a cleaner sleep screen, and a few settings tidy-ups.
...
*Upgrading from 1.7.0: no action needed — cached books and settings are preserved. A BookFusion book downloaded earlier that still shows a blank cover will pick one up after a re-download (or via **Developer Mode → Recache Library**).*
